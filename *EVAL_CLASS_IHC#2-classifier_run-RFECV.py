...
res2.to_excel(data_folder + "/CLASSIFIER/IHC/RES_features-RFECV_frequencies.xlsx", index=False)
...
res.to_excel(data_folder + "/CLASSIFIER/IHC/RES_features-RFECV.xlsx", index=False)
fig.savefig(data_folder + "/CLASSIFIER/IHC/PLOT_features-RFECV.png", dpi=300)
