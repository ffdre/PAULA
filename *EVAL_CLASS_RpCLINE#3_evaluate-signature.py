...
#########################
to_predict = pd.read_excel(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/RES_CCL_binary.xlsx", index_col=0).transpose()
data = pd.read_excel(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/RES_binary.xlsx", index_col=0).transpose() #contains clusters, IDs removed as they are indices
candidates = pd.read_excel(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/RES_features-RFECV_frequencies.xlsx")
...
res.to_excel(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/RES_features-RFECV_evaluate.xlsx", index=False)
fig.savefig(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/PLOT_features-RFECV_avaluate.png", dpi=300)
...
prediction.to_excel(data_folder + "/CLASSIFIER/CLINES_RNA_by_proteome/RES_prediction_RNA-%s.xlsx"%classes, index=False)
